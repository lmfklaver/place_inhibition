...
% Grating Power Spectra:
    % Averaged over all VR trials
         [wavespec_gratings_all] = getWavespec_AroundEvent(basePath, analogin_VR, lfp_channel, VR, tr_ep, gratingSwitch_pos);
...
% Reward Power Spectra:
    % All Trials
        [wavespec_reward_all] = getWavespec_AroundEvent(basePath, analogin_VR, lfp_channel, VR, tr_ep, reward_pos);
...
% Stim Location Power Spectra:
    % All Trials
        [wavespec_stim_all] = getWavespec_AroundEvent(basePath, analogin_VR, lfp_channel, VR, tr_ep, stim_pos);
